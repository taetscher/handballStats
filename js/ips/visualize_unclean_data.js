...
export function vizUnClean(data){
    ...
    for (n=0; n < data.length; n++ ){
        ...
        for (e in statistics_r){
            if (statistics_r[e] == ""){
                ...
                statistics_r[e] = eval(statistics_r[e])*100;
            }
        }
    ...
    for (n=0; n < len; n++ ){
        ...
        //get values for tooltip/labeling
        var stat_text = Object.values(data[n]);
        stat_text.shift();
        for (e in stat_text){
            if (stat_text[e] == ""){
                stat_text[e] = "NoAttempts";
            }
            else {
        ...
        for (e in statistics){
            if (statistics[e] == ""){
                ...
                statistics[e] = eval(statistics[e])*100;
            }
        }
        ...
        for(var i=0;i<dates.length;i++){
           xy.push({x:dates[i],y:statistics[i],text:stat_text[i]});
        }
